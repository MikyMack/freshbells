            ...
            <div className="relative overflow-hidden group hover:shadow-slate-500 shadow-xl">
              ...
              <div className="py-1 flex flex-col gap-1 border-[1px] border-t-0 px-4 bg-[#f5f3f3] group-hover:bg-[#ffffff]">
                ...
                <div className="flex items-center justify-between">
                  <select className="order-1 mt-1 hover:bg-primeColor font-medium font-body2 text-black hover:text-white xl:text-[25px] lg:text-[20px] md:text-[15px] xs:text-[15px] sm:text-[15px]">
                    {
                  ...
                  <div className="flex items-center order-2">
                    ...
                    <span className="px-4 text-lg  bg-gray-300">{getCartQuantity(product._id)}</span>
                ...
                <div className={`md:text-lg lg:text-xl sm:text-sm font-normal text-center xs:text-sm ${product.stock === 0 || (product.stock > 0 && product.stock < 10) ? 'text-red-500' : 'text-green-500'}`}>
