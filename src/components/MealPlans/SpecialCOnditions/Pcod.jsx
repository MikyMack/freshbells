...
export default function Pcod() {
    ...
    return (
        ...
        <div className="max-w-container mx-auto px-4 pb-12">
            <Breadcrumbs title="Diet Plan For PCOS" />
            <section>
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap mt-10">
          <div className="w-full lg:w-full px-4 mb-6 lg:mb-0"> 
            <h3 className="text-2xl font-semibold font-body2 mb-4"> DIET PLAN FOR PCOS</h3>
        ...
        <div className="flex flex-wrap items-center">
          <div className="w-full xl:w-1/2 px-4 mb-6 xl:mb-0">
            <img className="w-full h-auto object-cover" src={pcod} alt="single-img-10" />
          </div>
